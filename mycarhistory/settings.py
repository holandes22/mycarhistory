# Django settings for mycarhistory project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mycarhistory.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'cncx6xw%fn2rychh@ega&amp;=m2hj@n@s=0dtn@lmau(k)_fj#d!*'
